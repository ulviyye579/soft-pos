...
import v1.az.unibank.softpos.dtoV2.requests.Company;
import v1.az.unibank.softpos.dtoV2.requests.POSV2;
import v1.az.unibank.softpos.dtoV2.responses.*;
...
import static v1.az.unibank.softpos.utils.ConstantsV2.*;
...
public class CorporateCustomerV2 implements CustomerCreatorV2 {
    ...
    public ResponseCustomerV2 createCustomer(Company company, String headerRequestorInitiatorRid) throws TransAxisException {
        try {
            ...
            if (response.getResult().equalsIgnoreCase(APPROVED_RESULT)) {
                ...
                responseCustomerV2.setExternalId(externalId);
                responseCustomerV2.setCode(SUCCESS_CODE_000);
                responseCustomerV2.setDescription(OK_RESULT);
            } else {
                responseCustomerV2.setCode(DECLINED_CODE_001);
    ...
    public BranchResponse createSubCustomer(BranchV2 branchV2, String headerRequestorInitiatorRid) throws TransAxisException, JAXBException {
        ...
        JAXBElement<Long> jaxbElementParentOrgId = new JAXBElement<>(NS_PARENT_QNAME, Long.class, Long.valueOf(branchV2.getClientID()));
    ...
    public SubCustomerV2 createSubObject(POSV2 POSV2, String headerRequestorInitiatorRid) throws Exception {
        ...
        department.setLegalTitle(jaxbElementTitle);
        department.setShortTitle(jaxbElementTitle);
        JAXBElement<Long> jaxbElementParentOrgId = new JAXBElement<>(NS_PARENT_QNAME, Long.class, Long.valueOf(POSV2.getClientID()));
        department.setParentOrgId(jaxbElementParentOrgId);
        JAXBElement<Long> jaxbElementMccId = new JAXBElement<>(NS_MCC_QNAME, Long.class, Long.valueOf(POSV2.getMccCode()));
        ...
        if (response.getResult().equalsIgnoreCase(ConstantsV2.APPROVED_RESULT)) {
            ...
            subCustomerV2.setExternalId(departmentId);
    ...
    public TerminalResponseV2 createTerminal(POSV2 POSV2, String headerRequestorInitiatorRid) throws Exception {
        ...
        if (terminalRid != null) {
            ...
            terminalResponseV2.setCode(SUCCESS_CODE_000);
            terminalResponseV2.setDescription(APPROVED_RESULT);
