...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:pain.008.001.04", "Document");
    private final static QName _DrctDbtTxInf_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:pain.008.001.04", "DrctDbtTxInf");
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.04", name = "Document")
    public JAXBElement<Document> createDocument(Document value) {
        return new JAXBElement<Document>(_Document_QNAME, Document.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DirectDebitTransactionInformation13 }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link DirectDebitTransactionInformation13 }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.04", name = "DrctDbtTxInf")
    public JAXBElement<DirectDebitTransactionInformation13> createDrctDbtTxInf(DirectDebitTransactionInformation13 value) {
        return new JAXBElement<DirectDebitTransactionInformation13>(_DrctDbtTxInf_QNAME, DirectDebitTransactionInformation13 .class, null, value);
    }
