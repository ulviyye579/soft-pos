...
/**
 * <p>Java class for CalcArpcRq complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CalcArpcRq"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="AuthRespCode" use="required" type="{http://schemas.radixware.org/types.xsd}BinHex" /&gt;
...
@XmlType(name = "CalcArpcRq", propOrder = {
    "iccAuthKey"
})
@XmlSeeAlso({
    CheckArpcRq.class
})
public class CalcArpcRq {
    ...
    protected byte[] arqc;
    @XmlAttribute(name = "AuthRespCode", required = true)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    protected byte[] authRespCode;
     ...
     *     
     */
    public void setAuthRespCode(byte[] value) {
